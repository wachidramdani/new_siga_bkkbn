...
import { Card, Form, FormGroup, Label, Input, Button, CardBody, CardHeader, Col, Row, Collapse } from 'reactstrap';
                    ...
                    <Card className="border-danger" style={{width: '60%', float: 'right'}}>
                        <CardHeader className="card-header-filter bg-danger">
                          ...
                          <div className="card-header-actions">
                            <a href="_blank" className="card-header-action btn btn-minimize pointer" onClick={this.toggleFilter}><i className="icon-minus2"></i></a>
                          </div>
                        </CardHeader>
