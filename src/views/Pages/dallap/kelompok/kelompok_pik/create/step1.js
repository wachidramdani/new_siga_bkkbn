                            ...
                            <CardBody className="card-body-nopad">
                                ...
                                <FormGroup>
                                    ...
                                    <Row style={{ marginTop: '15px' }}>
                                        ...
                                        <Col md="6" xs="8">
                                            <Select id="pengelola" name="pengelola" options={this.state.pengelola} onChange={this.changePengelola} value={this.state.valuePengelola} placeholder="Pengelola" isClearable />
                                        </Col>
                                        <Col md="2" xs="4">
                                            {
