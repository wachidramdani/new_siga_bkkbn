...
class KelompokPIK extends Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
    ...
    handleClickOpen = () => {
        ...
        this.props.history.push('/kegiatan/kelompok_pik/create');
    }

    handleSeacrh = () => {
        this.props.history.push('/kegiatan/kelompok_pik/daftar');
    }
                            ...
                            <Card>
                                <CardBody>
                                    <div className="divTitle">
                                        <span className="spanTitle">&#8226; Pendaftaran Kelompok Kegiatan PIK-R/M </span>
                                    </div>
                                    <Row>
                                        <Col md="12">
                                            <Row>
