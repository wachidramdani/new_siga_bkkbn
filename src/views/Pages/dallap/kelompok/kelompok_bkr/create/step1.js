                            ...
                            <CardBody className="card-body-nopad">
                                <FormGroup>
                                    ...
                                    <Row style={{ marginTop: '15px' }}>
                                        ...
                                        <Col xs="12" md="9">
                                            <Select options={this.state.optPrioritas} onChange={this.handlePrioritas} value={this.state.setPrioritas} isClearable placeholder="Pilih Prioritas Nasional" maxMenuHeight={140} />
                                        </Col>
                                    </Row>  
                                </FormGroup>
                            </CardBody>
