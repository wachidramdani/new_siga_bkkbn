...
class RegisterPIK extends Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
    ...
    handleSeacrh = () => {
        this.props.history.push('/kegiatan/register_pik/daftar');
    }
                            ...
                            <Card>
                                <CardBody>
                                    <div className="divTitle">
                                        <span className="spanTitle">&#8226; Pendaftaran Kelompok Kegiatan PIK-R/M Register</span>
                                    </div>
                                    <Row>
                                        <Col md="12">
                                            <Row>
