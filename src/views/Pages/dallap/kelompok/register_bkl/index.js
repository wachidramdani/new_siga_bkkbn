...
class RegisterBkl extends Component {
    constructor(props) {
        super(props);
        this.state = {
            open: false,
    ...
    handleClickOpen = () => {
        ...
        this.props.history.push('/kegiatan/register_bkl/create');
    }

    handleSeacrh = () => {
        this.props.history.push('/kegiatan/register_bkl/daftar');
    }
                        ...
                        <Col xs="12" md="7">
                            <Card>
                                <CardBody>
                                            ...
                                            <Row>
                                                ...
                                                <Col xs="7" md="8 mb-2" style={{paddingLeft:'20px'}}>
                                                    <Row>
                                                        ...
                                                        <Col xs="4" md="3">
                                                            <Label className="labelForm28" htmlFor="kabupaten"><b>J.BKL</b></Label>
                                                        </Col>
                                                        <Col xs="8" md="9">
                                    ...
                                    <Row className="mt-2">
                                        <Col xs="5" md="4">
                                            <Label className="labelForm28" htmlFor="kabupaten"><b>BKL</b></Label>
                                        </Col>
                                        <Col xs="7" md="8">
                                        ...
                                        <Col xs="5" md="4">
                                            <Label className="labelForm28" htmlFor="kabupaten"><b>No. Kelompok BKL</b></Label>
                                        </Col>
                                        <Col xs="7" md="8">
