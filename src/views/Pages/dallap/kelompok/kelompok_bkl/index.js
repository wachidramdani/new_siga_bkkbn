...
class KelompokBKL extends Component {
    ...
    handleClickOpen = () => {
        ...
        this.props.history.push('/kegiatan/kelompok_bkl/create');
    }

    handleSeacrh = () => {
        this.props.history.push('/kegiatan/kelompok_bkl/daftar');
    }
                            ...
                            <Card>
                                <CardBody>
                                    <div className="divTitle">
                                        <span className="spanTitle">&#8226; Pendaftaran POKTAN Bina Keluarga Lansia (BKL) </span>
                                    </div>
                                    <Row>
                                        <Col md="12">
                                            <Row>
