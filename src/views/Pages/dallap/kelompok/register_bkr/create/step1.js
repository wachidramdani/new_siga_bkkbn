                        ...
                        <Col sm="12">
                            ...
                            <CardBody className="card-body-nopad mt-3">
                                <FormGroup>
                                    <Row>
                                        <Col lg="4">
                                            <Input type="text" className="text-center" value={sessionStorage.getItem('nama_kelompok')} disabled />
                                        ...
                                        <Col lg="4">
                                            <Input style={{ marginRight: '5px', textAlign: 'center' }} type="read-only" value={sessionStorage.getItem('kd_kec')} disabled />
                                            <Label className="labelHeader">Kode Kecamatan</Label>
                                        </Col>
                                        <Col lg="4">
                                            <Input type="number" className="text-center" value={sessionStorage.getItem('kd_poktan')} disabled />
                                            <Label className="labelHeader">Kode Poktan</Label>
                                        </Col>
                                        <Col lg="4">
                                            <Input type="text" className="text-center" value={sessionStorage.getItem('no_regis')} disabled />
