...
class CreatePKB extends Component {
    constructor(props) {
        super(props);
        this.state = {
            expanded: 'panel1',
                    ...
                    <Col xs="12" md="12">
                        <Card>
                            <CardBody>
                                <Row>
                                    <Col md="12">
                                        <div className="titleFilter"><i className="icon-clipboard3"></i> Pendafataran PKB/PLKB</div>
                                    </Col>
                                    <Col xs="12" md="12"><hr style={{ borderBottom: '1px solid orange', marginTop: '5px' }} /></Col>
                                    <Col sm="12">
                                        <h6>IDENTITAS PKB/PLKB </h6>
                                                ...
                                                <Row>
                                                    ...
                                                    <Col md="12" xs="12">
                                                        ...
                                                        <Row>
                                                            ...
                                                            <Col md="2" xs="4" style={{ marginTop: '10px' }} className="d-flex justify-content-end">
                                                                <Label>e-Mail :</Label>
                                                            </Col>
                                                            <Col md="3" xs="8" style={{ marginTop: '10px' }}>
                                                                <Input type="text" id="text-input" name="text-input" value="" />
                                                            </Col>
                                                        </Row>
                                                    </Col>
