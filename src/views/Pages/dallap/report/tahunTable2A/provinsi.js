...
class Provinsi extends Component {	
    ...
    CellFormatter(cell, row) {
        return (<div><Link to={`/table2ADallap/kabupaten?kabupaten=${row.provinsi}`}>{row.provinsi}</Link></div>);
    }
    ...
    render() {
        ...
        return (
            ...
            datas =  {
                [
                    { id: 1, kode: 11,provinsi: 'ACEH SELATAN',dt1:23,dt2:58,dt3:49,dt4:32,dt5:98,dt6:12,dt7:39,dt8:88,dt9:37,dt10:29,dt11:44,dt12:213,dt13:40,dt14:20,dt15:39,dt16:16,dt17:95,dt18:344,dt19:49,dt20:77},
                    { id: 2, kode: 12,provinsi: 'ACEH UTARA',dt1:23,dt2:58,dt3:49,dt4:32,dt5:98,dt6:12,dt7:39,dt8:88,dt9:37,dt10:29,dt11:44,dt12:213,dt13:40,dt14:20,dt15:39,dt16:16,dt17:95,dt18:344,dt19:49,dt20:77}
                ]
            }
            excelData = {
            ...
            title = {"PENYULUHAN (PKB)"}
            namaLaporan = {`PENYULUHAN (PKB)`}
            marginLeft = {400}
            fontSize = {8}
            header = {
                [
