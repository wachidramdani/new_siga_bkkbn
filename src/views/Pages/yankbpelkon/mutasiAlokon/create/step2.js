...
class Step2 extends Component {
    constructor(props) {      
        ...
        this.state = {
            ...
            show_alokon: [
                {value:'1', label:'1. APBN', sumberAlokon:'apbn'},
                {value:'2', label:'2. APBD', sumberAlokon:'apbd'},
                {value:'3', label:'3. Mandiri', sumberAlokon:'mandiri'},
            ],
            value_alokon: null,

            showMutasiAlokon:null,

            value_mutasiAlokon: null,
                            ...
                            <CardBody className="card-body-nopad mt-3">
                                ...
                                <FormGroup>
                                    <Row>
                                        ...
                                        <Col xs="8" md="4">
                                            <Select options={this.state.show_alokon} onChange={this.changeAlokon} value={this.state.value_alokon} isClearable />
                                        </Col>
                                        <Col xs="4" md="2">
                                            <Label className="labelForm">Mutasi Alokon</Label>
                                        </Col>
                                        <Col xs="8" md="4">
                                            <Select options={this.state.showMutasiAlokon} onChange={this.handleMutasi} value={this.state.value_mutasiAlokon} isDisabled={this.state.disableMutasiAlokon} isClearable />
                                        </Col>
