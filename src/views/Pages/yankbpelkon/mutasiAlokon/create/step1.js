                                    ...
                                    <Row>
                                        ...
                                        <Col lg="4">
                                            ...
                                            <div style={{ float: 'left', width: '48%' }}>
                                                <Input type="text" id="bulan" name="bulan" value={tahun} className="text-center" disabled />
                                            </div>
                                        ...
                                        <Col xs="3" lg="2">
                                            <Input className="mt-3 text-center" type="text" id="text-input" name="text-input" value={this.state.nomorLembar} disabled />
                                        </Col>
                                    </Row>
                                </FormGroup>
                            </CardBody>
