...
class ListBdki extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            currentPage: 0,
            data: [
                {"id":1, "issue":"Petugas A","desc":"12-02-1993", "date":"2020-07-14", "status": "New", "priority": "Troubleshooting", "facility":"Block A", "valtype":"Increase Production", "attapp":"Known", "atttm":"3175092502941002"},
                {"id":2, "issue":"Petugas B","desc":"12-02-1993", "date":"2020-07-13", "status": "New", "priority": "Fit For Purpose", "facility":"South Sokang", "valtype":"Reduce Cost", "attapp":"Known", "atttm":"3175092502941003"},
