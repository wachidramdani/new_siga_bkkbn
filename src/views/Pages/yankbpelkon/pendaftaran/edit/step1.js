                            ...
                            <CardBody>
                                ...
                                <Row>
                                    <Col md="3" xs="6" style={{ textAlign: 'center' }} >
                                        <Row>
                                            <Input style={{ marginRight: '5px', textAlign: 'center' }} type=" text" id="text-input" name="text-input" value={this.state.kodeProv}  />
                                        </Row>
                                        <Row >
                                    ...
                                    <Col md="3" xs="6">
                                        <Row>
                                            <Input style={{ marginRight: '5px', textAlign: 'center' }} type=" text" id="text-input" name="text-input" value={this.state.kodeKab}  />
                                        </Row>
                                        <Row>
                                            <Col md="12" style={{ textAlign: 'center' }}>
                                    ...
                                    <Col md="3" xs="6">
                                        <Row>
                                            <Input type="number" style={{ marginRight: '5px', textAlign: 'center' }} id="text-input" name="text-input" value={this.state.datas.nomorRegisterFaskesKB}  />
                                        </Row>
                                        <Row>
                                            <Col md="12" style={{ textAlign: 'center' }}>
                                    ...
                                    <Col md="3" xs="6">
                                        <Row>
                                            <Input type="number" style={{ marginRight: '5px', textAlign: 'center' }} id="text-input" name="text-input" value={this.state.datas.nomorJaringanJejaringFaskesKB}  />
                                        </Row>
                                        <Row>
                                            <Col md="12" style={{ textAlign: 'center' }}>
                        ...
                        <div style={{position:'absolute', right: '20px', marginTop:'-30px', fontSize:'12px'}}>{this.props.currentStep}/{this.props.totalSteps}</div>
                            <FormGroup>
                                <Row>
                                    ...
                                    <Col md="4">
                                        <Input type="text" id="text-input" name="text-input" value={this.state.datas.namaTempatPelayananKB}   />
                                    </Col>
                                </Row>
                                <Row>
                                    <Col md="12">
                                        ...
                                        <Row>
                                            ...
                                            <Col md="4" style={{ paddingTop: '10px' }}>
                                                <Input type="text" id="text-input" name="text-input" value={this.state.datas.alamatJalan}   />
                                            </Col>
                                            <Col md="2" xs="6" style={{ paddingTop: '10px' }}>
                                                <Row>
                                                    <Col md="3" xs="4"><Label className="labelForm">RT</Label></Col>
                                                    <Col md="9" xs="8"><Input type=" text" id="text-input" name="text-input" value={this.state.namaRt}    /></Col>
                                                </Row>
                                            </Col>
                                            <Col md="2" xs="6" style={{ paddingTop: '10px' }}>
                                                <Row>
                                                    <Col md="3" xs="4"><Label className="labelForm">RW</Label></Col>
                                                    <Col md="9" xs="8"><Input type=" text" id="text-input" name="text-input" value={this.state.namaRw}   /></Col>
                                                </Row>
                                            </Col>
                                        </Row>
                                        <Row>
                                            ...
                                            <Col md="7" xs="9" style={{marginTop:'10px'}}>
                                                <Input type="text" id="text-input" name="text-input" value={this.state.namaKel}   />
                                            </Col>
                                            <Col md="1" xs="3" style={{marginTop:'10px'}}>
                                                <Input type="text" id="text-input" name="text-input" value={this.state.kodeKel}   />
                                            </Col>
                                        </Row>
                                        <Row>
                                            <Col md="4" style={{marginTop:'10px'}}>
                                            ...
                                            <Col md="7" xs="9" style={{marginTop:'10px'}}>
                                                <Input type="text" id="text-input" name="text-input" value={this.state.namaKec}   />
                                            </Col>
                                            <Col md="1" xs="3" style={{marginTop:'10px'}}>
                                                <Input type="text" id="text-input" name="text-input" value={this.state.kodeKec}   />
                                            </Col>
                                        </Row>
                                        <Row>
                                            <Col md="4" style={{marginTop:'10px'}}>
                                            ...
                                            <Col md="7" xs="9" style={{marginTop:'10px'}}>
                                                <Input type="text" id="text-input" name="text-input" value={this.state.namaKab}   />
                                            </Col>
                                            <Col md="1" xs="3" style={{marginTop:'10px'}}>
                                                <Input type="text" id="text-input" name="text-input" value={this.state.kodeKab}   />
                                            </Col>
                                        </Row>
                                        <Row>
                                            <Col md="4" style={{marginTop:'10px'}}>
                                            ...
                                            <Col md="7" xs="9" style={{marginTop:'10px'}}>
                                                <Input type="text" id="text-input" name="text-input" value={this.state.namaProv}   />
                                            </Col>
                                            <Col md="1" xs="3" style={{marginTop:'10px'}}>
                                                <Input type="text" id="text-input" name="text-input" value={this.state.kodeProv}   />
                                            </Col>
                                        </Row>
                                    </Col>
                                </Row>
                                ...
                                <Row style={{ paddingTop: '20px' }}>
                                    ...
                                    <Col md="2" style={{ paddingTop: '10px' }}>
                                        <Select placeholder="Jenis Faskes KB" options={this.state.jenisTempatLayanan} value={this.state.showJenisTempatLayanan} is  isClearable />
                                    </Col>
                                    <Col md="2" style={{ paddingTop: '10px' }}>
                                        <Select placeholder="Jenis Tingkat Faskes KB" options={this.state.tingkatFaskes} value={this.state.showTingkatFaskes} is  isClearable />
                                    </Col>
                                    <Col md="2" style={{ paddingTop: '10px' }}>
                                        <Select placeholder="Jenis Tingkat Pelayanan" options={[...this.state.select1, ...this.state.select2]} value={this.state.showSel} is  isClearable />
                                    </Col>
                                </Row>
                                <Row style={{ marginTop: '15px' }}>
                                    ...
                                    <Col md="2" style={{ paddingTop: '10px' }}>
                                        <Select placeholder="Status Kepemilikan" options={this.state.Kepemilikan} value={this.state.showKepemilikan} is  isClearable />
                                    </Col>
                                </Row>
                                <Row style={{ marginTop: '15px' }}>
                                    <Col md='4' style={{ paddingTop: '10px' }}>
                                    ...
                                    <Col md="2" style={{ paddingTop: '10px' }}>
                                        <Select options={this.state.kbPerusahaan} value={this.state.showKbPerusahaan} is  isClearable />
                                    </Col>
                                    <Col md="1" style={{ paddingTop: '10px' }}>
                                        <Label>PKBRS</Label>
                                    </Col>
                                    <Col md="2" style={{ paddingTop: '10px' }}>
                                        <Select options={this.state.pkbrs} value={this.state.showPkbrs} is  isClearable />
                                    </Col>
                                </Row>
                                <Row style={{ marginTop: '15px' }}>
                                    <Col md="4" xs="12" style={{ paddingTop: '10px' }}>
                                    ...
                                    <Col md="2" xs="6" style={{ paddingTop: '10px' }}>
                                        <Select options={this.state.kerjasamaBpjs} value={this.state.showKerjasamaBpjs} is  isClearable />    
                                    </Col>
                                    <Col md="2" xs="6" style={{ paddingTop: '10px' }}>
                                        <Select options={this.state.kerjasamaBpjsLnsgTdk} value={this.state.showKerjasamaBpjsLnsgTdk} is  isClearable />    
                                    </Col>
                                </Row>
                                        ...
                                        <Row style={{ marginTop: '5px' }}>
                                            ...
                                            <Col md="4">
                                                ...
                                                <Row style={{ marginTop: '15px' }}>
                                                    ...
                                                    <Col md="6">
                                                        <Input type="text" id="text-input" name="text-input" value={this.state.nomorPKSLangsung}   />
                                                    </Col>
                                                </Row>
                                                <Row style={{ marginTop: '15px' }}>
                                                    <Col md="4">
                                                    ...
                                                    <Col md="6">
                                                        <Input type="text" id="text-input" name="text-input" value={this.state.masaBerlakuPKSLangsung}   />
                                                    </Col>
                                                </Row>
                                                <Row style={{ marginTop: '15px' }}>
                                                    <Col md="4">
                                                    ...
                                                    <Col md="6">
                                                        <Input type="text" id="text-input" name="text-input" value={this.state.masaBerlakuPKSLangsungAkhir}   />
                                                    </Col>
                                                </Row>
                                                <Row style={{ marginTop: '15px' }}>
                                                    <Col md="4">
                                                    ...
                                                    <Col md="6">
                                                        <Input type="text" id="text-input" name="text-input" value={this.state.nomorRegisterPKSLangsung}   />
                                                    </Col>
                                                </Row>
                                            </Col>
                                        </Row>
                                        ...
                                        <Row style={{ marginTop: '5px' }}>
                                            ...
                                            <Col md="4">
                                                ...
                                                <Row style={{ marginTop: '15px' }}>
                                                    ...
                                                    <Col md="6">
                                                        <Input type="text" id="text-input" name="text-input" value={this.state.nomorPKSTidakLangsung}   />
                                                    </Col>
                                                </Row>
                                                <Row style={{ marginTop: '15px' }}>
                                                    <Col md="4">
                                                    ...
                                                    <Col md="6">
                                                        <Input type="text" id="text-input" name="text-input" value={this.state.masaBerlakuPKSTidakLangsung}   />
                                                    </Col>
                                                </Row>
                                                <Row style={{ marginTop: '15px' }}>
                                                    <Col md="4">
                                                    ...
                                                    <Col md="6">
                                                        <Input type="text" id="text-input" name="text-input" value={this.state.masaBerlakuPKSTidakLangsungAkhir}   />
                                                    </Col>
                                                </Row>
                                            </Col>
                                        </Row>
