...
class DetailKabupaten extends Component {	
    ...
    render() {
        ...
        return (
            ...
            namaLaporan = {`Tenaga Pada Tempat Pelayanan KB di ${params.kabupaten}`}
            marginLeft = {360}
            fontSize = {7}
            header = {
                [
                    [
                        ...
                        { content: 'Nama',rowSpan:3, styles: { halign: 'center' } },
                        { content: 'Alamat',rowSpan:3, styles: { halign: 'center' } },
                        { content: 'Kelurahan',rowSpan:3, styles: { halign: 'center' } },
            ...
            column = {
                [
                    { width:"50",dataField:'kode', title: "Kode", row: '0', rowSpan: '3', headerAlign: POSITION.CENTER, dataAlign: POSITION.LEFT },
                    { width:"150",dataField:'nama', title: "Nama", row: '0', rowSpan: '3', headerAlign: POSITION.CENTER, dataAlign: POSITION.LEFT },
                    { width:"150",dataField:'alamat', title: "Alamat", row: '0', rowSpan: '3', headerAlign: POSITION.CENTER, dataAlign: POSITION.LEFT },
                    { width:"100",dataField:'kelurahan', title: "Kelurahan", row: '0', rowSpan: '3', headerAlign: POSITION.CENTER, dataAlign: POSITION.LEFT },
