...
class Provinsi extends Component {	
    ...
    CellFormatter(cell, row) {
        return (<div><Link to={`/table15B/kabupaten?kabupaten=${row.provinsi}`}>{row.provinsi}</Link></div>);
    }
    ...
    render() {
        ...
        return (
            ...
            namaLaporan = {`Tempat Pelayanan KB Berdasarkan Jenis Di Wilayah Daerah Terpencil, Perbatasan, Dan Kepulauandi ${params.provinsi}`}
            marginLeft = {200}
            header = {
                [
                    [
