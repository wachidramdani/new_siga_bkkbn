...
import CommonReport from '../CommonReportCustomFooter';
        ...
        return (
            ...
            column = {
                [
                    ...
                    { width:"150",dataFormat: this.CellFormatter,dataField:'provinsi',title: "Keacamatan", row: '0', rowSpan: '2', headerAlign: POSITION.CENTER, dataAlign: POSITION.LEFT },
                    { width:"150",dataField: "nama",title: "Nama", row: '0',rowSpan:2, headerAlign: POSITION.CENTER, dataAlign: POSITION.LEFT },
                    { width:"190",dataField: "alamat",title: "Alamat", row: '0',rowSpan:2, headerAlign: POSITION.CENTER, dataAlign: POSITION.LEFT },
                    ...
                    { width:"100",dataField: "dt8",title: "Laparoskopi", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt8",title: "Ruang  Operasi", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt8",title: "Lampu Periksa  (Eximination Link)", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt8",title: "Ruang  Konseling  KB Dan  Kesehatan Reproduksi", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt8",title: "Materi  Kesehatan  Reproduksi", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt8",title: "Sarana Komputer / Laptop", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                ]
            }
            back = {
