...
class Detail extends Component {	
    ...
    CellFormatter(cell, row) {
        return (<div><Link to={`/table9A/provinsi?provinsi=${row.provinsi}`}>{row.provinsi}</Link></div>);
    }
    ...
    render() {
        ...
        return (
            ...
            namaLaporan = {`Sarana Perlengkapan Yang Bisa Dipakai Pada Tempat Pelayanan KB`}
            marginLeft = {260}
            fontSize = {8}
            header = {
                [
