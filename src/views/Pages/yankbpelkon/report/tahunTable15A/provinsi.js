...
class Provinsi extends Component {	
    ...
    CellFormatter(cell, row) {
        return (<div><Link to={`/table15A/kabupaten?kabupaten=${row.provinsi}`}>{row.provinsi}</Link></div>);
    }
    ...
    render() {
        ...
        return (
            ...
            namaLaporan = {`Tempat Pelayanan KB Berdasarkan Jenis Di Wilayah Miskin di ${params.provinsi}`}
            marginLeft = {260}
            header = {
                [
                    [
