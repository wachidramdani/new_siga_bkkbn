...
class DetailKabupaten extends Component {	
    ...
    render() {
        ...
        return (
            ...
            namaLaporan = {`Sarana Perlengkapan Yang Bisa Dipakai Pada Tempat Pelayanan KB di ${params.kabupaten}`}
            marginLeft = {260}
            fontSize = {7}
            header = {
                [
            ...
            column = {
                [
                    ...
                    { width:"100",dataField: "dt1", title: "Jumlah Tempat Pelayanan KB", row: '0', rowSpan: '2', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",title: "FKRTL Berdasarkan Jenis", row: '0', colSpan: '4', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt2", title: "Jumlah FKRTL", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt3", title: "Klinik Utama", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt4", title: "RS Umum", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt5", title: "RS Khusus", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",title: "FKRTP Berdasarkan Jenis", row: 0, colSpan: '5', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt6", title: "Jumlah FKTP", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt7", title: "Puskesmas", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt8", title: "Praktek Dokter", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt9", title: "Klinik Pratama", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt10", title: "RS Tipe D PRatama", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",title: "Jaringan Berdasarkan Jenis", row: 0, colSpan: '4', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt11", title: "Jumlah Jaringan", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt12", title: "Pustu", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt13", title: "Pusling", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt14", title: "Poskendes / Polindes", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",title: "Jejaring", row: 0, headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                    { width:"100",dataField: "dt15",title: "Praktik Bidan", row: '1', headerAlign: POSITION.CENTER, dataAlign: POSITION.RIGHT },
                ]
            }
            back = {
