...
import { Card, CardBody, Col, Label, Row, Button, Collapse, Fade, Form, Modal, ModalHeader, ModalBody } from 'reactstrap';
...
class Registrasi extends Component {
    ...
    handleCreate = () => {
        ...
        sessionStorage.setItem('no_faskes', this.state.detailDatas2[3]);
        sessionStorage.setItem('no_jaringan', this.state.detailDatas2[4] ? this.state.detailDatas2[4] : '-');
        sessionStorage.setItem('lembar', this.state.detailDatas2[5]);
    ...
    render() {
        ...
        // function namaYanKB(cell) {
        //     let namaYanKB = cell;
        //     let nama;
        //     switch (namaYanKB) {
        //         case undefined: nama = this.state.detailDatas2[0]; break;
        //         case null: nama = this.state.detailDatas2[0]; break;
        //         case '': nama = this.state.detailDatas2[0]; break;
        //         default: nama = "-";
        //     }
        //     return nama;
        // }
                                    ...
                                    <Row>
                                        ...
                                        <Col md="12">
                                            <Fade in={this.state.open}>
                                                <Button className="btn btn-facebook" onClick={this.handleCreate}> <i className="icon-plus3 d-inline mr-1"></i> Tambah </Button>
                                            </Fade>
                                        </Col>
                                    </Row>
