...
class Step2 extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            show_dataNonBDKI: [],
            namaPeserta: '',
            kkiPeserta: '', nikPeserta: '', dataPeserta: [],
    ...
    componentDidMount() {
        this.setPesertaKB(sessionStorage.getItem('id'), sessionStorage.getItem('bulan'));
    }
    ...
    handleClickDelete = (row) => {
        ...
        this.setState({
            // dataPeserta: this.state.dataPeserta.splice(0, this.state.dataPeserta.indexOf(row)),
            // dataPeserta: this.state.dataPeserta.splice(this.state.dataPeserta.indexOf(row), 1),
            // dataPeserta: this.state.dataPeserta.filter(item => item !== valuePeserta)
        },
            // () => {
            //     if (noPeserta > -1) {
            //         this.setState({
            //             dataPeserta: this.state.dataPeserta.splice(noPeserta, 1)
            //         })
            //     }
            // }
        )
    ...
    handleNext = (event) => {
        ...
        const step2 = [{
            ...
            "tahun": this.state.date.getFullYear(),
    ...
    render() {
        ...
        const columnPeserta = [
            ...
            },
            {
                ...
                // formatter: (cell, row, rowIndex) => {
                //     let tindakan = (this.state.currentPage - 1) * this.state.sizePerPage + (rowIndex + 1);
                                    ...
                                    <Row>
                                        ...
                                        <Col xs="12" lg="4" align="right">
                                            <Collapse isOpen={!this.state.btnEdit}>
                                                <button className="btn btn-primary" onClick={this.addPeserta}>Tambah</button>

                                            </Collapse>
                                            <Collapse isOpen={this.state.btnEdit}>
                                                <button className="btn btn-success" onClick={this.addPeserta}>Ubah</button>
                                            </Collapse>
                                        </Col>
                                    </Row>
                                </FormGroup>
